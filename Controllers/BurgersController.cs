...
namespace AnthonyRodriguezejercicio1.Controllers
{
    public class BurgersController : Controller
    {
        private readonly AnthonyRodriguezejercicio1Context _context;

        public BurgersController(AnthonyRodriguezejercicio1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'AnthonyRodriguezejercicio1Context.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AnthonyRodriguezejercicio1Context.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
